...
export const NPC_HENRY: CharacterBase = {
  ...
  initialMemories: [
    `ACADEMIC_HISTORY: Henry used to be in the same psychology class as Molly, but failed and changed to history. PERSONAL_ADMIRATION: He admires the fact that Molly is a good student and is very fond of her.`,
    ...
    `FAMILY_PRESSURE: Henry's familty doesn't understand his passion for history, they think it's a waste of time. LIFE_STAGE: They also want him to get a job and become independent, but he's not ready to do that yet.`,
