...
export const NPC_MOLLY: CharacterBase = {
  ...
  money: 50,
  initialMemories: [
    `EDUCATION_HISTORY: Molly initially wanted to study medicine, but failed a math exam which prevented her to enter med school. This failure still affects her self confidence and is a source of disappointment.`,
    `GAMING_HISTORY: Molly only recently started to play board games and card games. She used to think gaming was boring before trying it.`,
    `LITERARY_PREFERENCES: Molly's favorite book is the Lords of the Rings. She also loves Arabian mythology and the 1001 Nights.`,
    `FOOD_PREFERENCES: Molly's favorite food is Chinese food. She particularly enjoys spicy Chinese dishes.`,
